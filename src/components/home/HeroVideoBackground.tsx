...
const SPLINE_SCENE_URL = 'https://prod.spline.design/b7NN4uG0LWAcl-c7/scene.splinecode';
...
export default function HeroVideoBackground() {
  ...
  return (
    <div className="absolute inset-0 w-full h-full z-0 overflow-hidden">
      ...
      {/* Spline 3D layer — sits on top of video, transparent background */}
      {shouldLoad && (
        <Suspense fallback={null}>
          <Spline
            ...
            style={{
              ...
              pointerEvents: 'none', // Don't block clicks on buttons/content
            }}
          />
        </Suspense>
      )}
